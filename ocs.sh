...
curl https://raw.githubusercontent.com/mfauzan199812/Deb1/master/file/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/mfauzan199812/Deb1/master/file/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget https://raw.githubusercontent.com/mfauzan199812/Deb1/master/ocs.zip
unzip ocs.zip
rm -f ocs.zip
chown -R www-data:www-data /home/fns/public_html
chmod -R g+rw /home/fns/public_html
