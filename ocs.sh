...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/mfauzan199812/Deb1/master/file/nginx.conf"
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/mfauzan199812/Deb1/master/file/vps.conf"
...
git init
git remote add origin https://github.com/mfauzan199812/ocs.git
