...
echo -e "----------------------------------------"
echo -e "\e[032;1mServer Ip:\e[0m $MYIP${red}${NC}"
echo -e "\e[032;1mCPU model:\e[0m $cname${NC}"
echo -e "\e[032;1mNumber of cores:\e[0m $cores${NC}"
echo -e "\e[032;1mCPU frequency:\e[0m $freq MHz${NC}"
echo -e "\e[032;1mTotal amount of ram:\e[0m $tram MB${NC}"
echo -e "\e[032;1mTotal amount of swap:\e[0m $vram MB${NC}"
echo -e "\e[032;1mSystem uptime:\e[0m $up${NC}"
