...
up=$( uptime | awk '{ $1=$2=$(NF-6)=$(NF-5)=$(NF-4)=$(NF-3)=$(NF-2)=$(NF-1)=$NF=""; print }' | sed 's/^[ \t]*//;s/[ \t]*$//' )
	# Output of result
echo -e ""
echo -e "____________________|•Welcome To Server Premium BogelSSH Team•|_________________________${NC}"
echo -e "______________________<<< Jangan Lupa Bahagia Ea Hari Ini >>>___________________________${NC}"
echo -e ""
