...
echo -e "----------------------------------------"
echo -e "\e[032;1mServer Ip:\e[0m ${red}$MYIP${NC}"
echo -e "\e[032;1mCPU model:\e[0m ${green}$cname${NC}"
echo -e "\e[032;1mNumber of cores:\e[0m ${red}$cores${NC}"
echo -e "\e[032;1mCPU frequency:\e[0m ${green}$freq MHz${NC}"
echo -e "\e[032;1mTotal amount of ram:\e[0m ${red}$tram MB${NC}"
echo -e "\e[032;1mTotal amount of swap:\e[0m ${green}$vram MB${NC}"
echo -e "\e[032;1mSystem uptime:\e[0m ${red}$up${NC}"
echo -e "\e[032;1mScript Mod By: \e[0m ${green}Mohammad Fauzan R (0895703796928) | BogelSSH TEAM${NC}"
echo -e "-------------------------------------------------------------"
echo -e ""
echo -e "${red}Apa Yang Ingin Anda Lakukan Sekarang Ini Sultan?${NC}"
